...
export class ContractSyncJobHandler {
  ...
  static getInstance(): ContractSyncJobHandler {
    if (!ContractSyncJobHandler._instance) {
      ContractSyncJobHandler._instance = new ContractSyncJobHandler({
        schedulerService: SchedulerService.getInstance(),
        contractService: ContractService.getInstance(),
      });
    }

    return ContractSyncJobHandler._instance;
  }
