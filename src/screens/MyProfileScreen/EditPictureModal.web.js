...
import { Linking, ActivityIndicator, Platform, View, Image } from 'react-native';
...
export function EditPictureModal(props) {
  ...
  const handleSave = async () => {
    if (imageToSave) {
      await dispatch(ducks.identity.operations.updateProfilePictureOperation(imageToSave.fileData, identityId));
    }
