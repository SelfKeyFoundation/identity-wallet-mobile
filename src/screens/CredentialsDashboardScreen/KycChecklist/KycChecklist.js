...
export function KycChecklist(props) {
	...
	return (
		<Container onScroll={handleScroll} scrollEventThrottle={160} style={{ position: 'relative' }}>
				...
				<Grid style={{ margin: 20 }}>
					...
					<Row marginTop={20}>
						...
						<Col style={{ paddingTop: 0 }}>
							<Paragraph>
								I understand SelfKey Wallet LLC will pass this information to CoinLoan. that will open an account on their platform at my request and will communicate with me at my submitted email address above.
							</Paragraph>
							{
								agreementError ? (
									<ErrorMessage>
